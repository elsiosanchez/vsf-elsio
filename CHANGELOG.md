...
### Changed / Improved
- Fix broken mega menu. Requires [one change](https://github.com/vuestorefront/vsf-vsf-elsio/issues/509#issuecomment-862174222) in the config. ([#509](https://github.com/vuestorefront/vsf-vsf-elsio/issues/509))
